...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Посты найдены",
                        "schema": {
                            "$ref": "#/definitions/internal_features_posts_transport_http.SearchPostsDTOResponse"
                        }
                    },
                    "400": {
                        "description": "Неверный запрос",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/internal_features_likes_transport.LikePostDTOResponse"
                        }
                    },
                    "400": {
                        "description": "Неверный запрос",
                    ...
                    "404": {
                        "description": "Такой пост не был найден",
                        "schema": {
                            "$ref": "#/definitions/github_com_tryingmyb3st_PolyTweet_internal_core_domain.CustomError"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_features_likes_transport.LikeStatusResponseDTO"
                        }
                    },
                    "401": {
    ...
    "definitions": {
        ...
        "internal_features_likes_transport.LikePostDTOResponse": {
            "type": "object",
            "properties": {
                "likes_count": {
                    "type": "integer"
        ...
        "internal_features_likes_transport.LikeStatusResponseDTO": {
            "type": "object",
            "properties": {
                "is_liked": {
                    "type": "boolean"
        ...
        "internal_features_posts_transport_http.SearchPostsDTOResponse": {
            "type": "object",
            "properties": {
                "posts": {
                    "type": "array",
